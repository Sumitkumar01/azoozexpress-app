...
function CCHeader() {
  ...
  const col2Class = "col-lg-6 col-md-6 mt-4 mt-lg-0 col-12 d-flex align-items-center justify-content-around";
  ...
  const headerText2ClassName =
    "text-capitalize text-center ff-m fs-2 fw-bold text-black m-0 p-0";
