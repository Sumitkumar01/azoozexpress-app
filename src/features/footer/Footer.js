                        ...
                        <div >
                          <div>
                            <div className="ft-title-block-1"> 
                              <h6 className="text-white text-md-start text-xs-center text-lg-start fw-semibold fs-4 ff-m">Company</h6>
                            </div>
                          </div>
                          <div>
                            <div >
                        ...
                        <div className="">
                          <div>
                            <div className="mb-3 pb-0">
                              <h6 className="elementor-heading-title text-white text-center  text-md-start  text-lg-start fw-semibold mb-2 fs-4 ff-m">
                                Reach Out to us
                              </h6>
                            </div>
                          </div>
                            ...
                            <div >
                              <ul className="list-group bg-black border-0 rounded-0 text-md-start text-center text-lg-start fs-normal">
                                ...
                                <li className="list-group-item elementor-icon-list-tex bg-black text-white border-0 p-0">
                                  <Link to="https://wa.me/+96896586404" style={{textDecoration:"none",color:"#ffffff"}}>
                                    <span >
                                      <IoLogoWhatsapp />
                                    </span>
                                    <span className="ps-2 ">
                    ...
                    <div className="row text-white justify-content-center ">
                      ...
                      <div className="col-lg-5 col-md-6 col-sm-12 aling-item-center">
                        <p className="text-center">
                          <Link to="http://65.1.2.151/privacy-policy/" className="link-light link-offset-2 p-1">
                            Privacy Policy
                          </Link>
                          |
                          <Link to="http://65.1.2.151/terms-of-service/" className="link-light link-offset-2 p-1">
                            Terms of Service
                          </Link>
                        </p>
                      </div>
                  ...
                  <div>
                    <div >
                      <p className="text-center text-light p-2">
                        ...
                        <Link to="https://www.fielmente.com/" className="link-light link-offset-2 p-1">
                          Fielmente.com
                        </Link>
                      </p>
                    </div>
